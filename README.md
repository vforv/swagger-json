...
const joiSchema = {
  body: Joi.object({
    ...
    password: Joi.string()
      ...
      .example("Somestrongpasswrod#"),
    salt: Joi.string()
      .required()
      .description("Salt for new user")
      .example("asdsdgdsafs324eqwedagsdfafsdf"),
  }).meta({ modelName: "Register" }),
  headers: Joi.object({
    authorization: Validation.tokenValidation
      .string()
      .token()
      .required()
      .description("Auth token")
      .example("asdasfadfasdsasdas"),
  }),
